...
Counted at the UI browser MCP contract milestone from the test source itself (vitest
...
| Rust (guest)   | unit (mod tests)            | 9     | 128   | `guest/src/*.rs` `#[cfg(test)] mod tests` |
...
Totals: **1094 TypeScript** test cases across 51 files, **373 Rust**

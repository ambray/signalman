...
```json
{
  "permissions": {
    "allow": [
      ...
      "mcp__signalman__signalman_cloud_connection_descriptor",
      "mcp__signalman__signalman_k8s_status",
    ...
    "ask": [
      ...
      "mcp__signalman__signalman_k8s_deploy",
      "mcp__signalman__signalman_k8s_rollback",

...
pub fn list_input() -> Value {
    json!({
        ...
        "properties": {
            ...
            "pattern": { "type": "string", "description": "Glob pattern over scenario id (e.g. 'ospiri/**')." }
        },
...
pub fn describe_input() -> Value {
    json!({
        "type": "object",
        "properties": {
            "id": { "type": "string", "description": "Scenario id (e.g. 'ospiri/v2/network-egress')." }
        },
        "required": ["id"],
        "additionalProperties": false
    })
...
pub fn form_descriptor_input() -> Value {
    json!({
        ...
        "properties": {
            "scenario": {
                "type": "string",
                "description": "Scenario id whose form to describe (e.g. 'ospiri/v2/network-egress')."
            }
        },
        "required": ["scenario"],
        "additionalProperties": false
